import type { LevainConfigA, LevainConfigB, LevainResult } from '../types'

export function calcLevainModeA(cfg: LevainConfigA, totalFlour: number): LevainResult {
...
export function calcLevainModeB(cfg: LevainConfigB): LevainResult {
